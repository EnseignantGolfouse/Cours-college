...
\title{Activité : Aires de rectangles (\textbf{corrigé})}
\date{}
\author{}
...
\begin{exercice}\ \vspace{0.5em}
	...
	\end{tikzpicture}
	\begin{itemize}
		\item Écrire une expression permettant de calculer la \textit{largeur} de ce rectangle.

		      \textbf{12cm + 7cm + 8 cm}
		\item Écrire une expression permettant de calculer l'aire total du rectangle en un coup, en n'utilisant que les nombres présents sur la figure. \textbf{(12cm + 7cm + 8 cm) × 22cm}
		\item Quelle est l'aire du rectangle ?

		      \textbf{(12cm + 7cm + 8 cm) × 22cm = 27cm × 22cm = 594cm²}
	\end{itemize}
\end{exercice}
...
\begin{exercice}\ \vspace{0.5em}
	...
	\begin{itemize}
		\item Écrire une expression permettant de calculer la \textit{largeur} de ce rectangle.
		      ...
		      \textbf{21cm + 16cm}
		\item Écrire une expression permettant de calculer la \textit{hauteur} de ce rectangle.
		...
		\item Écrire une expression permettant de calculer l'aire total du rectangle en un coup, en n'utilisant que les nombres présents sur la figure.
		      ...
		      \textbf{(21cm + 16cm) × (19cm + 13cm)}
		\item Quelle est l'aire du rectangle ?

		      \textbf{(21cm + 16cm) × (19cm + 13cm) = 37cm × 32cm = 1184cm²}
	\end{itemize}
\end{exercice}
...
\begin{exercice*}[Bonus]\
	...
	\begin{itemize}
		\item Écrit une expression pour calculer l'aire de chacun des rectangles 1 et 2.

		      \textbf{rectangle 1 : 11cm × 13cm}

		      \textbf{rectangle 2 : 6cm × 13cm}
		\item Écrit une expression pour calculer l'aire du rectangle 3.

		      \textbf{rectangle 3 : (11cm + 6cm) × 13cm}
		\item Écrit une expression qui combine l'aire des rectangles 1 et 2 pour obtenir l'aire du rectangle 3.

		      \textbf{11cm × 13cm + 6cm × 13cm = (11cm + 6cm) × 13cm}

		      \textbf{Dans les deux cas, le résultat est 221cm².}
	\end{itemize}
\end{exercice*}
