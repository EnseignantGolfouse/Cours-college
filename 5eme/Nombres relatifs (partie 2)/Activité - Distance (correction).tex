...
\begin{exercice}\
	...
	\begin{enumerate}
		\item Quelle est la distance entre $A$ et $B$ ? \correction{$3$}
		\item Quelle est la distance entre $B$ et $C$ ? \correction{$4$}
		\item Quelle est la distance entre $A$ et $C$ ? \correction{$7$}
		\item On place un point $D$ d'abscisse $20$. Quelle est la distance entre $B$ et $D$ ? \correction{$21$}
		\item On place un point $E$ d'abscisse $200$. Quelle est la distance entre $C$ et $E$ ? \correction{$197$}
	\end{enumerate}
\end{exercice}
...
\begin{exercice}\
	...
	\end{itemize}
	\begin{enumerate}
		\item Quelle est la distance entre $A$ et $B$ ? \correction{$32$}
		\item      Quelle est la distance entre $B$ et $C$ ? \correction{$23$}
		\item      Quelle est la distance entre $A$ et $C$ ? \correction{$9$}
	\end{enumerate}
\end{exercice}
