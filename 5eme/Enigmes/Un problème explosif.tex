...
\Copy{Explosion}{
	...
	\begin{enumerate}
		...
		\item On suppose maintenant que 1234 n'a pas le droit de faire tourner deux fois de suite la même roue : il doit changer de roue à chaque fois. Peut-il encore désamorcer la bombe ? Comment ?
	\end{enumerate}
}
